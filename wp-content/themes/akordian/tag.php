	...
	<section class="page active loaded fullwidth">	
		...
		<div class="content grid" style="display: block;">
			<div class="page-header c12">
				<h1>
					<?php if(isset($akordian_redux_demo['tag_title']) && $akordian_redux_demo['tag_title']!=''){?>
						<?php echo esc_attr($akordian_redux_demo['tag_title']);?>
					<?php }else{?>
						<?php echo esc_html__( 'Tag:', 'akordian' );?>
					<?php } ?>
					<?php printf( esc_html__( ' %s', 'akordian' ), single_tag_title( '', false ) );?>
				</h1>
