<?php
/**
 * Plugin Name: Akordian Elementor
...
final class BdevsElementor {
	...
	public function admin_notice_missing_main_plugin() {
		...
		$message = sprintf(
			...
			'<strong>' . esc_html__( 'Akordian Elementor', 'bdevs-elementor' ) . '</strong>',
	...
	public function add_elementor_category() {
    	\Elementor\Plugin::instance()->elements_manager->add_category('bdevs-elementor',
	      	array(
					'title' => __( 'Akordian Elementor', 'bdevs-elementor' ),
					'icon'  => 'fa fa-plug',
	      	) 
	    );
	}
	...
	*/
	...
	public function init_widgets() { 
		...
		require_once plugin_dir_path( __FILE__ ) . 'widgets/home-section.php';
		require_once plugin_dir_path( __FILE__ ) . 'widgets/about-section.php';
		require_once plugin_dir_path( __FILE__ ) . 'widgets/portfolio-section.php';
		require_once plugin_dir_path( __FILE__ ) . 'widgets/blog-section.php';
		require_once plugin_dir_path( __FILE__ ) . 'widgets/contact-section.php';
		require_once plugin_dir_path( __FILE__ ) . 'widgets/footer-section.php';
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BdevsElementor\Widget\BdevsFooterSection() );
